...
namespace Core.Extensions
{
    public class ConfigurationManager
    {
        ...
        /// 默认路径
        /// </summary>
        private static readonly string _defaultPath = Directory.GetCurrentDirectory() + "\\appsettings.json";
        ...
        /// 配置节点关键字
        /// </summary>
        private static readonly string _configSection = "AppSettings";

        /// <summary>
        /// 配置外连接的后缀
        /// </summary>
        private static readonly string _configUrlPostfix = "Url";
